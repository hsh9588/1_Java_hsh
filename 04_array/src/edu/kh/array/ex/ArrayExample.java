...
public class ArrayExample {
	...
	/*
	 * 
	 * 배열 ( 자료구조 ) - 같은 자료형의 변수를 하나의 묶음으로 다루는 것. - 묶여진 변수들은 하나의 이름 ( 배열명 )으로 불러지고 각
	 * 변수들은 index 를 이용하여 구분함.
	 * 
	 * 변수 : 1개의 자료형, 1개의 값 저장 배열 : 1개의 자료형, n개의 값 저장
	 * 
	 */
	...
	public void ex1() {
		...
		// int 형 변수 4개를 묶음으로 다룰 수 있는 배열을 생성하고
		// 이를 arr 이라고 부름
	...
	public void ex6() {
		...
		String[] menuArr = { "제육볶음", "맥도날드", "치즈돈까스", "떡볶이", "삼겹살", "안심돈까스", "맘스터치", "빵", "백반", "파스타" };
	...
	public void ex7() {
		...
		// 인원 수를 입력 받아 그 크기 만큼의 정수 배열을 선언 및 할당
		// 반복문을 이용하여 인원 수 만큼 점수를 입력 받아
		// 합계, 평균, 최고점, 최저점을 출력
		...
		for (int i = 0; i < scoreArr.length; i++) {
			...
			sum += scoreArr[i]; // 점수를 입력 받자 마자 sum에 누적
		}
		...
		// for문에 break poing를 지정하면 증감식이 해석되기 전에 멈춘다 (debug mode)
	...
	public void ex10() {
		...
		// 1) for문을 이용한 방법 ( index 가 동일하다는 특징을 이용 )
