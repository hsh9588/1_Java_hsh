...
public class Example1 {
	...
	public void ex1() {
		...
		// Truck 이 Car로 부터 상속 받은 메서드
		c2.setWheel(4);
		c2.setSeat(1);
		c2.setFuel("휘발유");

//		c2.setWeigth(1.5); // 에러
		// The method setWeigth(double) is undefined for the type Car
		// 참조변수가 부모 타입이기 때문에
...
//		System.out.println(c1.toString());
	...
	public void ex2() {
		...
		arr[2] = new Spark(4, 4, "휘발류", 0.5); // Spark 객체 ( 업캐스팅 )
		// Car 참조 변수
