...
public class StudentManagementView {
	...
	public void updateStudent() {
		...
		if (result == -1) {
			System.out.println("입력한 값이 인덱스 볌위를 초과했습니다.");			
		} else if (result == 0) {
	...
	public void selectName() {
		...
		if (resultArr == null) {
			...
			for (int i = 0; i < resultArr.length; i++) {
				...
				System.out.printf("%s(%d학년 %d반 %d)", resultArr[i].getName(),
						resultArr[i].getGrade(), resultArr[i].getClassRoom(),
