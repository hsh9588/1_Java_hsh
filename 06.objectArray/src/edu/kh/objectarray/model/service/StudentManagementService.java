...
public class StudentManagementService {
	...
	public StudentManagementService() {
		stdArr[0] = new Student(1, 3, 24, "석일", 60, 70, 100);
		stdArr[1] = new Student(2, 7, 19, "석이", 50, 60, 100);
		stdArr[2] = new Student(3, 5, 31, "석삼", 40, 50, 100);
		stdArr[3] = new Student(4, 9, 33, "석사", 30, 40, 100);
	}
	...
	public int updateStudent(int idx, int kor, int eng, int math) {
		...
		if (idx < 0 || idx >= stdArr.length) { // 범위 초과 시
			...
			if (stdArr[idx] == null) { // 인덱스가 null인 경우
				return 0;
			} else { // 범위 초과 x, null x -> 학생 정보 존재
