...
public class ServerService {
	...
	/* TCP
	 * - 서버, 클라이언트간의 1:1 소켓 통신(연걸 지향적 프로토콜)
	 * - 서버가 먼저 실행되어 있는 상태에서 클라이언트가 연결해야한다.
	 * 
	 * - 데이터 전송 순서가 보장되고, 수신 여부를 판단하여 
	 * 	 오류(손실) 발생 시 재전송한다.
	 * 
	 * java.net 패키지에서 제공하는 
	 * Socket, ServerSocket 클래스를 사용해야한다.
	 * 
	 * Socket
	 * - 프로세스의 양 끝단(프로세스간의 통신을 담당)
	 * - Input/OutputStream을 보유하고 있다.
	 * 
	 * ServerSocket
